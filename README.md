...
**100 merged contributions across 4 repos:**
...
- [#6673](https://github.com/gastownhall/beads/pull/6673) — fix(configfile): persist effective proxy idle timeout
- *…and 3 more — [see all 5](https://github.com/search?q=repo%3Agastownhall%2Fbeads+is%3Apr+is%3Amerged+author%3Arjgeng&type=pullrequests)*
